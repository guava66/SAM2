...
if __name__ == "__main__":
    ...
    # python /data/pyhData/3DSAM-adapter-main/3DSAM-adapter/train.py --data brain --snapshot_path "./work_dir" --data_prefix "/data/pyhData/MedSAM-MedSAM2/data/npz_train/BraTS-PED" 
